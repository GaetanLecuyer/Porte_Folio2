...
urlpatterns = [
    # Include TinyMCE URLs for rich text editing
    ...
    path('accounts/profile/update-username/',
         update_username, name='update_username'),
    path('accounts/profile/update-profile-picture/',
         update_profile_picture, name='update_profile_picture'),
]

# Include media URLs in DEBUG mode
if settings.DEBUG:
